...
void __setup_funcids()
{
	...
	audio_exists = loader_yyc_get_funcid("audio_exists");
	audio_sound_get_loop = loader_yyc_get_funcid("audio_sound_get_loop");
	audio_sound_loop_start = loader_yyc_get_funcid("audio_sound_loop_start");
	audio_sound_loop_end = loader_yyc_get_funcid("audio_sound_loop_end");
	audio_create_buffer_sound = loader_yyc_get_funcid("audio_create_buffer_sound");
	audio_free_buffer_sound = loader_yyc_get_funcid("audio_free_buffer_sound");
	...
	sprite_flush = loader_yyc_get_funcid("sprite_flush");
