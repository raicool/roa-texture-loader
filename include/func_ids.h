...
inline int audio_sound_get_loop;
inline int audio_sound_loop_start;
inline int audio_sound_loop_end;
inline int audio_create_buffer_sound;
inline int audio_free_buffer_sound;
